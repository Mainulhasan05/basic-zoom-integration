...
app.post('/', (req, res) => {
  ...
  const oPayload = {
    appKey: "WjVrtAtISuya6Js7kF0YfQ", //client id
    sdkKey: "WjVrtAtISuya6Js7kF0YfQ",  // client id
    mn: meetingNumber,
    role,
    iat,
    exp,
  ...
  const sdkJWT = KJUR.jws.JWS.sign('HS256', sHeader, sPayload, "1NQOhX1CYDlyWq1nWXZM4gUCkx8YNWB9") //client secret
